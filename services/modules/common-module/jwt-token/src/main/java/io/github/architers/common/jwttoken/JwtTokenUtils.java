...
public class JwtTokenUtils {
    ...
    public static void main(String[] args) {
        ...
        roleInfos.add(new UserInfo.RoleInfo("1", "1", "角色1"));
        roleInfos.add(new UserInfo.RoleInfo("2", "2", "角色2"));
        roleInfos.add(new UserInfo.RoleInfo("3", "3", "角色2"));
        roleInfos.add(new UserInfo.RoleInfo("4", "4", "角色2"));
        roleInfos.add(new UserInfo.RoleInfo("5", "5", "角色2"));
        roleInfos.add(new UserInfo.RoleInfo("6", "6", "角色2"));
        roleInfos.add(new UserInfo.RoleInfo("7", "7", "角色2"));
        roleInfos.add(new UserInfo.RoleInfo("8", "8", "角色2"));
