package com.architecture.ultimate.starter.web.response;
...
public class ResponseResultHttpMessageConverter extends AbstractHttpMessageConverter<ResponseResult> {
    ...
    @Override
    protected ResponseResult readInternal(Class<? extends ResponseResult> clazz, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        return null;
    }

    @Override
    protected void writeInternal(ResponseResult responseResult, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
