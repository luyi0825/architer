package io.github.architers.contenxt.expression;
...
public class ExpressionParser {
    ...
    public Object parserExpression(ExpressionMetadata expressionMetadata, String expression) {
        MethodBasedEvaluationContext expressionEvaluationContext = createEvaluationContext(expressionMetadata);
    ...
    public static MethodBasedEvaluationContext createEvaluationContext(ExpressionMetadata metadata) {
        ...
        MethodBasedEvaluationContext expressionEvaluationContext = new MethodBasedEvaluationContext(
