...
vue-pure-admin is a free and open source middle and back-end template. Using the latest `vue3`, `vite2`, `TypeScript`
, `Element-Plus` and other mainstream technology development, the out-of-the-box middle and back-end front-end solutions
...
You are very welcome to join！[Raise an issue](https://github.com/xiaoxian521/vue-pure-admin/issues/new/choose) Or submit
a Pull Request
