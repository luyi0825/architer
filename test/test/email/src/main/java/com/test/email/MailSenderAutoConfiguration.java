...
public class MailSenderAutoConfiguration {
    ...
    @Bean
    public MailSenderRegister mailSenderRegister(MailProperties mailProperties, MailSenderSelector mailSenderSelector) {
        return new MailSenderRegister(mailProperties, mailSenderSelector);
    }

    @Bean
    public MailSenderSelector mailSenderSelecter() {

        return new MailSenderHealthySelector();
