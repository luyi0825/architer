 ...
 */
@SpringBootTest
public class MapBatchPutCacheTest {

    @Resource
    private RedissonClient redissonClient;

    @Resource
    private MapBatchPutCacheService mapBatchPutCacheService;
    ...
    public void batchPutMap() {
        ...
        mapBatchPutCacheService.batchPutMap(cacheInfo);
    }
    ...
    public void batchPutCollection() {
        ...
        mapBatchPutCacheService.batchPutCollection(cacheUsers);
    }
