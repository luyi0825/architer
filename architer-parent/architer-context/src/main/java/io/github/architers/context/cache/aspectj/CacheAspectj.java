package io.github.architers.context.cache.aspectj;//package com.architecture.context.cache.aspectj;
...
public class CacheAspectj {
     ...
     * caching切点
     */
    @Pointcut("@annotation(io.github.architers.context.cache.annotation.Cacheable)")
