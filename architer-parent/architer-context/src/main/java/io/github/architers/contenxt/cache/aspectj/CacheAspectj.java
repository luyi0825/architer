package io.github.architers.contenxt.cache.aspectj;//package com.architecture.context.cache.aspectj;
...
public class CacheAspectj {
     ...
     * caching切点
     */
    @Pointcut("@annotation(io.github.architers.contenxt.cache.annotation.Cacheable)")
