 ...
 */
public abstract class LockSourcePointcut extends StaticMethodMatcherPointcut implements Serializable {


    public LockSourcePointcut() {
        this.setClassFilter(new CacheOperationSourceClassFilter());
    }

    public LockSourcePointcut(@Nullable ClassFilter classFilter) {
    ...
    public boolean matches(Method method, Class<?> targetClass) {
        LockOperationSource cas = getCacheOperationSource();
        return (cas != null && !CollectionUtils.isEmpty(cas.getCacheOperations(method, targetClass)));
    }


    public abstract LockOperationSource getCacheOperationSource();
