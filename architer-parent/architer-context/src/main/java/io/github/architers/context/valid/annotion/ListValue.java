...
import io.github.architers.context.valid.validator.ListValueValidatorForNumber;
import io.github.architers.context.valid.validator.ListValueValidatorForString;
...
//支持重复注解
@Repeatable(ListValue.ListValues.class)
