...
public class GlobalExceptionHandler {
    ...
    public BaseResponse gateWayValidException(WebExchangeBindException exception) {
        return getBindExceptionBaseResponse(exception.getBindingResult());
    }
...
//    }
    ...
    private BaseResponse getBindExceptionBaseResponse(BindingResult bindingResult) {
        ...
        BaseResponse baseResponse=  new BaseResponse(StatusCode.PARAMS_VALID_EXCEPTION.getCode(),  fieldErrorList.get(0).getDefaultMessage());
