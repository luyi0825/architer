...
public class SendVerificationCodeMessageAdapterImpl implements SendMessageAdapter {
    ...
    private boolean sendMailVerificationCode(Email email, MessageTemplate messageTemplate) {
        ...
        //设置有效期
        cacheManager.set(codeKey, verificationCode, messageTemplate.getExpireTime() * 60L, TimeUnit.SECONDS);
        return true;
    }
    ...
    @Autowired
    public SendVerificationCodeMessageAdapterImpl setCacheService(CacheManager cacheManager) {
